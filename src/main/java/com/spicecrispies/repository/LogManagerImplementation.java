...
public class LogManagerImplementation implements LogInterface {
    ...
    @Override
    public List<LogEntry> getChangeLogs(String fromDate, String toDate, String changeType) throws LogFault {
        ...
        if (!changeType.equals("")) {
            if (changeType.equals("CREATE") || changeType.equals("UPDATE") || changeType.equals("DELETE")) {
                ...
                throw new LogFault("Only valid ChangeType(CREATE, UPDATE, DELETE) accepted !!");
            }
        }
        ...
        if (fromDateTime == null || toDateTime == null) {
            throw new LogFault("ERROR: Cannot accept null dates");
        }
    ...
    public String clearLogs() throws LogFault {
        throw new LogFault("Method not implemented.");
    }
}
